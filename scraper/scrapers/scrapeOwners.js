...
var regexes = [
    ...
    // /(?: dated .*?,)?\s(?:executed|certain Mortgage)(?:on|made by)?.*? (?:by|from) (.*?),? (?:married|unmarried) and (?:wife,\s|husband,\s)?(.*?),? (?:married|unmarried)/i,
    ...
    /(?: dated .*?,)?\s(?:executed|certain Mortgage)(?:on|made by)?.*? (?:by|from) (.*?),? and (?:wife|spouse|husband|married),? (.*?),? to/i,

    /(?: dated .*?,)?\s(?:executed|certain Mortgage)(?:on|made by)?.*? (?:by|from) (.*?),? and (.*?),?\s?(?:and|to)/i,
